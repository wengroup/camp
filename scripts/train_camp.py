...
def main(config: dict):
    ...
    # TODO, need to pass config to load_model and update it accordingly in case we want
    #  to to overwrite the config in the checkpoint.
    #  This is needed if one some of the hyperparameters are changed in retraining
    #  For example, one might want to change lr_scheduler_hparams to watch on energy
    #  instead of forces that is in the original checkpoint.
...
if __name__ == "__main__":
    ...
    config_file = Path(__file__).parent / "configs" / "config_camp.yaml"
